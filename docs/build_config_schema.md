...
- [9. Property `root > local_factors_path`](#local_factors_path)
- [10. Property `root > build_btap_cli`](#build_btap_cli)
- [11. Property `root > build_btap_batch`](#build_btap_batch)
- [12. Property `root > local_nrcan`](#local_nrcan)
- [13. Property `root > compute_environment`](#compute_environment)
...
## <a name="os_standards_branch"></a>4. Property `root > os_standards_branch`
...
| **Type**     | `string`                        |
| **Required** | No                              |
| **Default**  | `"resources/costing/costs.csv"` |

**Description:** Path to the local costs.csv costing file.  The default is '<this btap_batch local repository location>/resources/costing/costs.csv'. If you are using a custom costing file, you can set the path. here

 Ignore this if you are not using costing or are content with the default costing_database.json costing file.

## <a name="local_factors_path"></a>9. Property `root > local_factors_path`

|              |                                               |
| ------------ | --------------------------------------------- |
| **Type**     | `string`                                      |
| **Required** | No                                            |
| **Default**  | `"resources/costing/costs_local_factors.csv"` |

**Description:** Path to the local costs_local_factors.csv costing localization factors file.  The default is '<this btap_batch local repository location>/resources/costing/costs_local_factors.csv'. If you are using

 a custom costing localization factors file, you can set the path here
...
## <a name="build_btap_cli"></a>10. Property `root > build_btap_cli`
...
## <a name="build_btap_batch"></a>11. Property `root > build_btap_batch`
...
## <a name="local_nrcan"></a>12. Property `root > local_nrcan`
...
## <a name="compute_environment"></a>13. Property `root > compute_environment`
...
----------------------------------------------------------------------------------------------------------------------------
Generated using [json-schema-for-humans](https://github.com/coveooss/json-schema-for-humans) on 2025-08-03 at 16:24:37 -0400
