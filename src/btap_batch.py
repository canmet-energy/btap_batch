                ...
                for file_object in os.listdir(folder_in_results_path):
                    ...
                    if file_object != 'sum_hourly_res.csv':
                        ...
                        if datapoint_empty == False:
                            ...
                            # Get whatever the 'Name' column of the df dataframe has and cnvert it to a list
                            df_names = df['Name']
                            df_names = df_names.to_list()
                            # Find duplicate items in df_names
                            df_names_duplicate = [i for n, i in enumerate(df_names) if i in df_names[:n]]
                            # Remove duplicate names from df_names_duplicate
                            df_names_duplicate = [i for n, i in enumerate(df_names_duplicate) if  i not in df_names_duplicate[:n]]
